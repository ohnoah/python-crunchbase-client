...
class AutocompleteResult(object):
    ...
    @property
    def entities(self):
        """Gets the entities of this AutocompleteResult.  # noqa: E501


        :return: The entities of this AutocompleteResult.  # noqa: E501
        :rtype: list[AutocompleteEntity]
        """
        return self._entities

    @entities.setter
    def entities(self, entities):
        """Sets the entities of this AutocompleteResult.


        :param entities: The entities of this AutocompleteResult.  # noqa: E501
        :type: list[AutocompleteEntity]
        """
        if entities is None:
