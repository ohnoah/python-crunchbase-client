...
class Category(object):
    ...
    swagger_types = {
        ...
        'created_at': 'datetime',
        'entity_def_id': 'str',
        'identifier': 'AllOfCategoryIdentifier',
        'name': 'str',
        'updated_at': 'datetime',
        'uuid': 'str'
    }
    ...
    def __init__(self, category_groups=None, created_at=None, entity_def_id=None, identifier=None, name=None, updated_at=None, uuid=None):  # noqa: E501
    ...
    def category_groups(self):
        """Gets the category_groups of this Category.  # noqa: E501
        ...
        :return: The category_groups of this Category.  # noqa: E501
    ...
    def category_groups(self, category_groups):
        """Sets the category_groups of this Category.

        Superset of Industries (e.g. Software, Mobile, Health Care)\\ Field Type: identifier_multi\\ Searchable: Yes\\ Search Operators: blank, includes, includes_all, not_includes, not_includes_all   # noqa: E501

        :param category_groups: The category_groups of this Category.  # noqa: E501
    ...
    def entity_def_id(self):
        """Gets the entity_def_id of this Category.  # noqa: E501

        Field Type: enum\\ Searchable: Yes\\ Search Operators: blank, eq, includes, not_eq, not_includes\\ Possible values are:  * category - Industry   # noqa: E501

        :return: The entity_def_id of this Category.  # noqa: E501
        :rtype: str
        """
    ...
    def entity_def_id(self, entity_def_id):
        """Sets the entity_def_id of this Category.

        Field Type: enum\\ Searchable: Yes\\ Search Operators: blank, eq, includes, not_eq, not_includes\\ Possible values are:  * category - Industry   # noqa: E501

        :param entity_def_id: The entity_def_id of this Category.  # noqa: E501
        :type: str
        """
    ...
    def identifier(self):
        ...
        Descriptive keyword for a Company (e.g. SaaS, Android, Cloud Computing, Medical Device)\\ Field Type: identifier\\ Searchable: Yes\\ Search Operators: blank, contains, eq, includes, not_contains, not_eq, not_includes, starts   # noqa: E501

        :return: The identifier of this Category.  # noqa: E501
        :rtype: AllOfCategoryIdentifier
        """
    ...
    def uuid(self, uuid):
        ...
        :param uuid: The uuid of this Category.  # noqa: E501
        :type: str
        """
